...
/*
            ...
            if(list.get(12).equals("1"))
                Famille.getDataElement(sqlCon, path,list.get(1));
            if(list.get(6).equals("1"))
                Comptet.getDataElement(sqlCon, path,list.get(1));
            if(list.get(8).equals("1"))
                Livraison.getDataElement(sqlCon, path,list.get(1));
            if(list.get(5).equals("1"))
                Article.getDataElement(sqlCon, path,list.get(1));
            if(list.get(9).equals("1")) {
                DocEntete.getDataElement(sqlCon, path, list.get(1));
                DocRegl.getDataElement(sqlCon, path, list.get(1));
            }
            if(list.get(10).equals("1"))
                DocLigne.getDataElement(sqlCon, path,list.get(1));
            if(list.get(11).equals("1")) {
                ReglEch.getDataElement(sqlCon, path,list.get(1));
                Reglement.getDataElement(sqlCon, path, list.get(1));
            }
            if(list.get(13).equals("1")) {
                ArtStock.getDataElement(sqlCon, path,list.get(1));
            }
            if(list.get(14).equals("1")) {
                EcritureC.getDataElement(sqlCon, path,list.get(1));
            }
