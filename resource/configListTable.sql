...
IF OBJECT_ID('dbo.F_CONDITION', 'U') IS NOT NULL AND COL_LENGTH('dbo.F_CONDITION', 'CO_NoSource') IS NULL
ALTER TABLE F_CONDITION ADD CO_NoSource INT

IF OBJECT_ID('dbo.F_CONDITION', 'U') IS NOT NULL AND COL_LENGTH('dbo.F_CONDITION', 'DataBaseSource') IS NULL
ALTER TABLE F_CONDITION ADD DataBaseSource NVARCHAR(50)
...
IF OBJECT_ID('config.ListArtCompta', 'U') IS NOT NULL AND COL_LENGTH('config.ListArtCompta', 'ACP_TypeFacture') IS NULL
ALTER TABLE config.ListArtCompta ADD ACP_TypeFacture INT
